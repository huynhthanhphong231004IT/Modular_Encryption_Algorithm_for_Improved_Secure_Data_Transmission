...
if __name__ == "__main__":
    ...
    try:
        recovered = extract_message_from_folder(output_folder)

        print("=" * 60)
        print("KHÔI PHỤC THÔNG TIN TỪ THƯ MỤC (D_Steganography.py)")
        print(f"Thư mục Stego đầu vào : {output_folder}")
        print(f"Thông điệp khôi phục  : {recovered}")
        print("=" * 60)
